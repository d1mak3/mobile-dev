...
import ru.mirea.kuimovda.lesson5.databinding.AccelerometerBinding;

//Экран, в котором используется результат с любого
//из имеющегося датчика
...
public class Accelerometer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ru.mirea.kuimovda.lesson5.databinding.AccelerometerBinding binding = AccelerometerBinding.inflate(getLayoutInflater());
